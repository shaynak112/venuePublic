...
?>
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="logo text-center wow fadeInDown">
							<a href="index.php"><img src="images/gaialogo2.png" alt="Gaia Logo" style='width:40%;margin-left:20%;'></a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-9 wow fadeInLeft" style="z-index: 9999;">
			...
			<div class="row">
				<div class="col-md-12 wow fadeInRight">
					...
					<div style='background-color:purple;color:white;vertical-align:top;margin-left:10%;margin-right:10%;display:inline-block;margin-bottom:10px;border-radius:15px;width:80%;padding:20px;margin-top:30px;margin-bottom:30px;'>
						...
						Monday: Yoga at 6 PM
						<br/>
						Tuessday: Meditation at 7 PM
						<br/>
						Wednesday: Dance at 6 PM
			...
			<div class="row">
				<div class="col-md-12 wow fadeInLeft">
					...
					<div style='width:20%;margin-left:1%;margin-right:1%;vertical-align:top;display:inline-block;'>
						<img src="images/art/davidjunk1.jpg" alt="David Junk Art" class="img-responsive portrait" style='width:100%;border:2px solid white;'>
						<div>Artwork by local artist, Dmitry Asaturian , <a href='http://www.davidjunk.com/' TARGET='_BLANK'>www.davidjunk.com</a></div>
					</div>

					<div style='width:20%;margin-left:1%;margin-right:1%;vertical-align:top;display:inline-block;'>
						<img src="images/art/saraj1.jpg" alt="Sara-J Art" class="img-responsive portrait" style='width:100%;border:2px solid white;'>
					...
					<div style='width:20%;margin-left:1%;margin-right:1%;vertical-align:top;display:inline-block;'>
						<img src="images/art/davidjunk2.jpg" alt="David Junk Art" class="img-responsive portrait" style='width:100%;border:2px solid white;'>
						<div>Artwork by local artist, Dmitry Asaturian , <a href='http://www.davidjunk.com/' TARGET='_BLANK'>www.davidjunk.com</a></div>
					</div>


					<div style='width:20%;margin-left:1%;margin-right:1%;vertical-align:top;display:inline-block;'>
						<img src="images/art/saraj2.jpg" alt="Sara-J Art" class="img-responsive portrait" style='width:100%;border:2px solid white;'>
						<div>Artwork by local artist, Sara Jiminez , <a href='https://www.instagram.com/saraj_arts/' TARGET='_BLANK'>www.instagram.com/saraj_arts</a></div>
					</div>
